...
export class SavingSearchModal extends Component {
    constructor(props) {
        super(props)
        this.state = {
            name_input: "",
        ...
        >
            <View style={style.main_view}>
                ...
                <ScrollView contentContainerStyle={style.main_view_tab}>
                    <TextInput mode="outlined" label="Saving's name" placeholder="Type something" onChange={(t) => {this.setState({name_input: t})}}></TextInput>
