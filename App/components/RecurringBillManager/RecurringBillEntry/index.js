                ...
                <View style={style.option}>
                    <Menu
                        ...
                        anchor={<TouchableOpacity onPress={() => {this.setState({visible: true})}}><Icon name='dots-vertical' size={24}></Icon></TouchableOpacity>}>
                            <Menu.Item disabled={this.props.paused} onPress={() => {this.setState({visible: false}); (this.props.onPausePress)? this.props.onPausePress() : () => {}}} icon="pause" title="Pause" />
                            <Menu.Item disabled={!this.props.paused} onPress={() => {this.setState({visible: false}); (this.props.onResumePress)? this.props.onResumePress() : () => {}}} icon="play" title="Resume" />
                            <Divider></Divider>
