...
export class LoanEntry extends Component {
    constructor(props) {
        super(props)
        this.state = {
            visible: false,
                ...
                <View style={style.option}>
                    <Menu
                        ...
                        anchor={<TouchableOpacity onPress={() => {this.setState({visible: true})}}><Icon name='dots-vertical' size={24}></Icon></TouchableOpacity>}>
                            <Menu.Item disabled={!this.props.active} onPress={() => {this.setState({visible: false}); (this.props.onPaymentPress)? this.props.onPaymentPress() : () => {}}} icon="cash-register" title="Payment" />
