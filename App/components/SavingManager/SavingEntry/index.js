                ...
                <View style={style.option}>
                    <Menu
                        ...
                        anchor={<TouchableOpacity onPress={() => {this.setState({visible: true})}}><Icon name='dots-vertical' size={24}></Icon></TouchableOpacity>}>
                            <Menu.Item disabled={!this.props.active} onPress={() => {this.setState({visible: false}); (this.props.onDepositPress)? this.props.onDepositPress() : () => {}}} icon="cash-plus" title="Deposit" />
                            <Menu.Item disabled={!this.props.active} onPress={() => {this.setState({visible: false}); (this.props.onWithdrawPress)? this.props.onWithdrawPress() : () => {}}} icon="cash-minus" title="Withdraw" />
                            <Menu.Item disabled={!this.props.active} onPress={() => {this.setState({visible: false}); (this.props.onDeactivatePress)? this.props.onDeactivatePress() : () => {}}} icon="block-helper" title="Deactivate" />
                            <Divider />
