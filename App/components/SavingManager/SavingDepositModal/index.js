...
import { createSavingDeposit } from "../../../logic/Screen-payment";
...
export class SavingDepositModal extends Component {
    ...
    async onHandleTransfer() {
        ...
        // })
        let res = await createSavingDeposit({
            from_wallet_id: this.state.walletSelectedId,
            for_saving_id: this.props.srcId,
            amount: parseFloat(this.state.amount) || 0,
            note: this.state.note,
        }).catch(err => {
            console.log(err)
                ...
                <View style={styles.background}>
                    <View style={styles.container}>
                        <View style={styles.header}>
                            ...
                            <Text style={styles.textHeader}>SAVING DEPOSIT</Text>
                        </View>
